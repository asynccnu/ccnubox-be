...
const (
	...
	CCNUService_GetLibraryToken_FullMethodName   = "/ccnu.v1.CCNUService/GetLibraryToken"
	CCNUService_CheckLibraryToken_FullMethodName = "/ccnu.v1.CCNUService/CheckLibraryToken"
)
...
type CCNUServiceClient interface {
	...
	GetLibraryToken(ctx context.Context, in *GetLibraryTokenRequest, opts ...grpc.CallOption) (*GetLibraryTokenResponse, error)
	CheckLibraryToken(ctx context.Context, in *CheckLibraryTokenRequest, opts ...grpc.CallOption) (*CheckLibraryTokenResponse, error)
}
...
func (c *cCNUServiceClient) GetLibraryToken(ctx context.Context, in *GetLibraryTokenRequest, opts ...grpc.CallOption) (*GetLibraryTokenResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetLibraryTokenResponse)
	err := c.cc.Invoke(ctx, CCNUService_GetLibraryToken_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *cCNUServiceClient) CheckLibraryToken(ctx context.Context, in *CheckLibraryTokenRequest, opts ...grpc.CallOption) (*CheckLibraryTokenResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CheckLibraryTokenResponse)
	err := c.cc.Invoke(ctx, CCNUService_CheckLibraryToken_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CCNUServiceServer interface {
	...
	GetLibraryToken(context.Context, *GetLibraryTokenRequest) (*GetLibraryTokenResponse, error)
	CheckLibraryToken(context.Context, *CheckLibraryTokenRequest) (*CheckLibraryTokenResponse, error)
...
func (UnimplementedCCNUServiceServer) GetXKCookie(context.Context, *GetXKCookieRequest) (*GetXKCookieResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetXKCookie not implemented")
}
func (UnimplementedCCNUServiceServer) LoginCCNU(context.Context, *LoginCCNURequest) (*LoginCCNUResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method LoginCCNU not implemented")
}
func (UnimplementedCCNUServiceServer) GetLibraryToken(context.Context, *GetLibraryTokenRequest) (*GetLibraryTokenResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetLibraryToken not implemented")
}
func (UnimplementedCCNUServiceServer) CheckLibraryToken(context.Context, *CheckLibraryTokenRequest) (*CheckLibraryTokenResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method CheckLibraryToken not implemented")
}
...
func RegisterCCNUServiceServer(s grpc.ServiceRegistrar, srv CCNUServiceServer) {
	// If the following call panics, it indicates UnimplementedCCNUServiceServer was
...
func _CCNUService_GetLibraryToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetLibraryTokenRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CCNUServiceServer).GetLibraryToken(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CCNUService_GetLibraryToken_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CCNUServiceServer).GetLibraryToken(ctx, req.(*GetLibraryTokenRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _CCNUService_CheckLibraryToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CheckLibraryTokenRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CCNUServiceServer).CheckLibraryToken(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CCNUService_CheckLibraryToken_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CCNUServiceServer).CheckLibraryToken(ctx, req.(*CheckLibraryTokenRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CCNUService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetLibraryToken",
			Handler:    _CCNUService_GetLibraryToken_Handler,
		},
		{
			MethodName: "CheckLibraryToken",
			Handler:    _CCNUService_CheckLibraryToken_Handler,
		},
	},
