...
func (x *DeleteUserReq) GetStudentId() string {
	if x != nil {
		return x.StudentId
	}
	return ""
...
const file_user_v1_user_proto_rawDesc = "" +
	...
	"\rDeleteUserReq\x12\x1c\n" +
	"\tstudentId\x18\x01 \x01(\tR\tstudentId\x12\x1a\n" +
	"\bpassword\x18\x02 \x01(\tR\bpassword\"\x10\n" +
	"\x0eDeleteUserResp2\xbf\x03\n" +
	"\vUserService\x127\n" +
	...
	"\x19GetLibraryDiscussionToken\x12\x1f.user.v1.GetLibraryTokenRequest\x1a .user.v1.GetLibraryTokenResponse\x12=\n" +
	"\n" +
	"DeleteUser\x12\x16.user.v1.DeleteUserReq\x1a\x17.user.v1.DeleteUserRespBDZBgithub.com/asynccnu/ccnubox-be/common/api/gen/proto/user/v1;userv1b\x06proto3"
...
var file_user_v1_user_proto_goTypes = []any{
	...
	(*DeleteUserReq)(nil),           // 8: user.v1.DeleteUserReq
	(*DeleteUserResp)(nil),          // 9: user.v1.DeleteUserResp
}
var file_user_v1_user_proto_depIdxs = []int32{
	...
	8, // 5: user.v1.UserService.DeleteUser:input_type -> user.v1.DeleteUserReq
	1, // 6: user.v1.UserService.SaveUser:output_type -> user.v1.SaveUserResp
	3, // 7: user.v1.UserService.CheckUser:output_type -> user.v1.CheckUserResp
	5, // 8: user.v1.UserService.GetCookie:output_type -> user.v1.GetCookieResponse
	7, // 9: user.v1.UserService.GetLibrarySeatToken:output_type -> user.v1.GetLibraryTokenResponse
	7, // 10: user.v1.UserService.GetLibraryDiscussionToken:output_type -> user.v1.GetLibraryTokenResponse
	9, // 11: user.v1.UserService.DeleteUser:output_type -> user.v1.DeleteUserResp
