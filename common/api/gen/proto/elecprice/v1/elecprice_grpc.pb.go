...
func (UnimplementedElecpriceServiceServer) GetBillingBalance(context.Context, *GetBillingBalanceRequest) (*GetBillingBalanceResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetBillingBalance not implemented")
}
func (UnimplementedElecpriceServiceServer) SetStandard(context.Context, *SetStandardRequest) (*SetStandardResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method SetStandard not implemented")
}
func (UnimplementedElecpriceServiceServer) GetStandardList(context.Context, *GetStandardListRequest) (*GetStandardListResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetStandardList not implemented")
}
func (UnimplementedElecpriceServiceServer) CancelStandard(context.Context, *CancelStandardRequest) (*CancelStandardResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method CancelStandard not implemented")
}
...
func RegisterElecpriceServiceServer(s grpc.ServiceRegistrar, srv ElecpriceServiceServer) {
	// If the following call panics, it indicates UnimplementedElecpriceServiceServer was
