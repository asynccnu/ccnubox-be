...
const (
	...
	CounterService_RebuildCounter_FullMethodName   = "/counter.v1.CounterService/RebuildCounter"
	CounterService_DecayCounter_FullMethodName     = "/counter.v1.CounterService/DecayCounter"
	CounterService_BoostScores_FullMethodName      = "/counter.v1.CounterService/BoostScores"
)
...
type CounterServiceClient interface {
	...
	RebuildCounter(ctx context.Context, in *RebuildCounterReq, opts ...grpc.CallOption) (*RebuildCounterResp, error)
	DecayCounter(ctx context.Context, in *DecayCounterReq, opts ...grpc.CallOption) (*DecayCounterResp, error)
	BoostScores(ctx context.Context, in *BoostScoresReq, opts ...grpc.CallOption) (*BoostScoresResp, error)
}
...
func (c *counterServiceClient) RebuildCounter(ctx context.Context, in *RebuildCounterReq, opts ...grpc.CallOption) (*RebuildCounterResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RebuildCounterResp)
	err := c.cc.Invoke(ctx, CounterService_RebuildCounter_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *counterServiceClient) DecayCounter(ctx context.Context, in *DecayCounterReq, opts ...grpc.CallOption) (*DecayCounterResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(DecayCounterResp)
	err := c.cc.Invoke(ctx, CounterService_DecayCounter_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *counterServiceClient) BoostScores(ctx context.Context, in *BoostScoresReq, opts ...grpc.CallOption) (*BoostScoresResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(BoostScoresResp)
	err := c.cc.Invoke(ctx, CounterService_BoostScores_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CounterServiceServer interface {
	...
	RebuildCounter(context.Context, *RebuildCounterReq) (*RebuildCounterResp, error)
	DecayCounter(context.Context, *DecayCounterReq) (*DecayCounterResp, error)
	BoostScores(context.Context, *BoostScoresReq) (*BoostScoresResp, error)
...
func (UnimplementedCounterServiceServer) RebuildCounter(context.Context, *RebuildCounterReq) (*RebuildCounterResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RebuildCounter not implemented")
}
func (UnimplementedCounterServiceServer) DecayCounter(context.Context, *DecayCounterReq) (*DecayCounterResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DecayCounter not implemented")
}
func (UnimplementedCounterServiceServer) BoostScores(context.Context, *BoostScoresReq) (*BoostScoresResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method BoostScores not implemented")
}
...
func _CounterService_RebuildCounter_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RebuildCounterReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CounterServiceServer).RebuildCounter(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CounterService_RebuildCounter_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CounterServiceServer).RebuildCounter(ctx, req.(*RebuildCounterReq))
	}
	return interceptor(ctx, in, info, handler)
}

func _CounterService_DecayCounter_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DecayCounterReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CounterServiceServer).DecayCounter(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CounterService_DecayCounter_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CounterServiceServer).DecayCounter(ctx, req.(*DecayCounterReq))
	}
	return interceptor(ctx, in, info, handler)
}

func _CounterService_BoostScores_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(BoostScoresReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CounterServiceServer).BoostScores(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CounterService_BoostScores_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CounterServiceServer).BoostScores(ctx, req.(*BoostScoresReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CounterService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "RebuildCounter",
			Handler:    _CounterService_RebuildCounter_Handler,
		},
		{
			MethodName: "DecayCounter",
			Handler:    _CounterService_DecayCounter_Handler,
		},
		{
			MethodName: "BoostScores",
			Handler:    _CounterService_BoostScores_Handler,
		},
	},
