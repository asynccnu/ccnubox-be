...
type GetSeatRecordRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	StuId         string                 `protobuf:"bytes,1,opt,name=stu_id,json=stuId,proto3" json:"stu_id,omitempty"`
	Date          []string               `protobuf:"bytes,2,rep,name=estimation,proto3" json:"estimation,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type GetDiscussionRequest struct {
	...
	Date          string                 `protobuf:"bytes,2,opt,name=estimation,proto3" json:"estimation,omitempty"`
...
const file_library_v1_library_proto_rawDesc = "" +
	...
	"\x04Resp\x12\x18\n" +
	"\amessage\x18\x01 \x01(\tR\amessage2\xc5\a\n" +
...
var file_library_v1_library_proto_msgTypes = make([]protoimpl.MessageInfo, 32)
var file_library_v1_library_proto_goTypes = []any{
	...
	(*Comment)(nil),                     // 27: library.v1.Comment
	(*CreateCommentReq)(nil),            // 28: library.v1.CreateCommentReq
	(*GetCommentResp)(nil),              // 29: library.v1.GetCommentResp
	(*ID)(nil),                          // 30: library.v1.ID
	(*Resp)(nil),                        // 31: library.v1.Resp
}
var file_library_v1_library_proto_depIdxs = []int32{
	...
	27, // 8: library.v1.GetCommentResp.Comment:type_name -> library.v1.Comment
	0,  // 9: library.v1.LibraryService.GetSeat:input_type -> library.v1.GetSeatRequest
	6,  // 10: library.v1.LibraryService.ReserveSeat:input_type -> library.v1.ReserveSeatRequest
	8,  // 11: library.v1.LibraryService.GetSeatRecord:input_type -> library.v1.GetSeatRecordRequest
	11, // 12: library.v1.LibraryService.GetCreditPoint:input_type -> library.v1.GetCreditPointRequest
	15, // 13: library.v1.LibraryService.GetDiscussion:input_type -> library.v1.GetDiscussionRequest
	19, // 14: library.v1.LibraryService.SearchUser:input_type -> library.v1.SearchUserRequest
	21, // 15: library.v1.LibraryService.ReserveDiscussion:input_type -> library.v1.ReserveDiscussionRequest
	23, // 16: library.v1.LibraryService.CancelReserve:input_type -> library.v1.CancelReserveRequest
	25, // 17: library.v1.LibraryService.ReserveSeatRandomly:input_type -> library.v1.ReserveSeatRandomlyRequest
	28, // 18: library.v1.LibraryService.CreateComment:input_type -> library.v1.CreateCommentReq
	30, // 19: library.v1.LibraryService.GetComments:input_type -> library.v1.ID
	30, // 20: library.v1.LibraryService.DeleteComment:input_type -> library.v1.ID
	1,  // 21: library.v1.LibraryService.GetSeat:output_type -> library.v1.GetSeatResponse
	7,  // 22: library.v1.LibraryService.ReserveSeat:output_type -> library.v1.ReserveSeatResponse
	9,  // 23: library.v1.LibraryService.GetSeatRecord:output_type -> library.v1.GetSeatRecordResponse
	12, // 24: library.v1.LibraryService.GetCreditPoint:output_type -> library.v1.GetCreditPointResponse
	16, // 25: library.v1.LibraryService.GetDiscussion:output_type -> library.v1.GetDiscussionResponse
	20, // 26: library.v1.LibraryService.SearchUser:output_type -> library.v1.SearchUserResponse
	22, // 27: library.v1.LibraryService.ReserveDiscussion:output_type -> library.v1.ReserveDiscussionResponse
	24, // 28: library.v1.LibraryService.CancelReserve:output_type -> library.v1.CancelReserveResponse
	26, // 29: library.v1.LibraryService.ReserveSeatRandomly:output_type -> library.v1.ReserveSeatRandomlyResponse
	31, // 30: library.v1.LibraryService.CreateComment:output_type -> library.v1.Resp
	29, // 31: library.v1.LibraryService.GetComments:output_type -> library.v1.GetCommentResp
	31, // 32: library.v1.LibraryService.DeleteComment:output_type -> library.v1.Resp
