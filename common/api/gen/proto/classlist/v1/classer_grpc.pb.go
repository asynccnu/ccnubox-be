...
const (
	...
	Classer_UpdateClassNote_FullMethodName         = "/classer.v1.Classer/UpdateClassNote"
	Classer_DeleteClassNote_FullMethodName         = "/classer.v1.Classer/DeleteClassNote"
	Classer_GetClassNatures_FullMethodName         = "/classer.v1.Classer/GetClassNatures"
)
...
type ClasserClient interface {
	...
	// 获取课程性质集合
	GetClassNatures(ctx context.Context, in *GetClassNaturesReq, opts ...grpc.CallOption) (*GetClassNaturesResp, error)
}
...
func (c *classerClient) UpdateClassNote(ctx context.Context, in *UpdateClassNoteReq, opts ...grpc.CallOption) (*UpdateClassNoteResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UpdateClassNoteResp)
	err := c.cc.Invoke(ctx, Classer_UpdateClassNote_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *classerClient) DeleteClassNote(ctx context.Context, in *DeleteClassNoteReq, opts ...grpc.CallOption) (*DeleteClassNoteResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(DeleteClassNoteResp)
	err := c.cc.Invoke(ctx, Classer_DeleteClassNote_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *classerClient) GetClassNatures(ctx context.Context, in *GetClassNaturesReq, opts ...grpc.CallOption) (*GetClassNaturesResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetClassNaturesResp)
	err := c.cc.Invoke(ctx, Classer_GetClassNatures_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ClasserServer interface {
	...
	// 获取课程性质集合
	GetClassNatures(context.Context, *GetClassNaturesReq) (*GetClassNaturesResp, error)
...
func (UnimplementedClasserServer) GetRecycleBinClassInfos(context.Context, *GetRecycleBinClassRequest) (*GetRecycleBinClassResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetRecycleBinClassInfos not implemented")
}
func (UnimplementedClasserServer) RecoverClass(context.Context, *RecoverClassRequest) (*RecoverClassResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method RecoverClass not implemented")
}
func (UnimplementedClasserServer) GetAllClassInfo(context.Context, *GetAllClassInfoRequest) (*GetAllClassInfoResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetAllClassInfo not implemented")
}
func (UnimplementedClasserServer) GetStuIdByJxbId(context.Context, *GetStuIdByJxbIdRequest) (*GetStuIdByJxbIdResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetStuIdByJxbId not implemented")
}
func (UnimplementedClasserServer) GetSchoolDay(context.Context, *GetSchoolDayReq) (*GetSchoolDayResp, error) {
	return nil, status.Error(codes.Unimplemented, "method GetSchoolDay not implemented")
}
func (UnimplementedClasserServer) UpdateClassNote(context.Context, *UpdateClassNoteReq) (*UpdateClassNoteResp, error) {
	return nil, status.Error(codes.Unimplemented, "method UpdateClassNote not implemented")
}
func (UnimplementedClasserServer) DeleteClassNote(context.Context, *DeleteClassNoteReq) (*DeleteClassNoteResp, error) {
	return nil, status.Error(codes.Unimplemented, "method DeleteClassNote not implemented")
}
func (UnimplementedClasserServer) GetClassNatures(context.Context, *GetClassNaturesReq) (*GetClassNaturesResp, error) {
	return nil, status.Error(codes.Unimplemented, "method GetClassNatures not implemented")
}
...
func RegisterClasserServer(s grpc.ServiceRegistrar, srv ClasserServer) {
	// If the following call panics, it indicates UnimplementedClasserServer was
...
func _Classer_UpdateClassNote_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateClassNoteReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ClasserServer).UpdateClassNote(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Classer_UpdateClassNote_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClasserServer).UpdateClassNote(ctx, req.(*UpdateClassNoteReq))
	}
	return interceptor(ctx, in, info, handler)
}

func _Classer_DeleteClassNote_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DeleteClassNoteReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ClasserServer).DeleteClassNote(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Classer_DeleteClassNote_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClasserServer).DeleteClassNote(ctx, req.(*DeleteClassNoteReq))
	}
	return interceptor(ctx, in, info, handler)
}

func _Classer_GetClassNatures_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetClassNaturesReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ClasserServer).GetClassNatures(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Classer_GetClassNatures_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClasserServer).GetClassNatures(ctx, req.(*GetClassNaturesReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Classer_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "UpdateClassNote",
			Handler:    _Classer_UpdateClassNote_Handler,
		},
		{
			MethodName: "DeleteClassNote",
			Handler:    _Classer_DeleteClassNote_Handler,
		},
		{
			MethodName: "GetClassNatures",
			Handler:    _Classer_GetClassNatures_Handler,
		},
	},
