...
type Registry struct {
	...
	Countersvc    string                 `protobuf:"bytes,4,opt,name=countersvc,proto3" json:"countersvc,omitempty"`
	Contentsvc    string                 `protobuf:"bytes,5,opt,name=contentsvc,proto3" json:"contentsvc,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Registry) GetCountersvc() string {
	if x != nil {
		return x.Countersvc
	}
	return ""
...
func (x *Registry) GetContentsvc() string {
	if x != nil {
		return x.Contentsvc
	}
	return ""
...
const file_conf_proto_rawDesc = "" +
	...
	"\tschoolday\x18\x05 \x01(\v2\x15.kratos.api.SchoolDayR\tschoolday\x12\x10\n" +
	"\x03env\x18\a \x01(\tR\x03env\x12*\n" +
	"\x04otel\x18\b \x01(\v2\x16.kratos.api.OtelConfigR\x04otel\"\x9b\x03\n" +
	"\x06Server\x12\x12\n" +
	...
	"\atimeout\x18\x03 \x01(\x05R\atimeout\"\xf5\x03\n" +
	"\x04Data\x125\n" +
	...
	"\rwrite_timeout\x18\x04 \x01(\x05R\fwriteTimeout\x1aY\n" +
	"\x05Kafka\x12\x18\n" +
	...
	"\ausersvc\x18\x02 \x01(\tR\ausersvc\x12\x1a\n" +
	"\bproxysvc\x18\x03 \x01(\tR\bproxysvc\x12\x1e\n" +
	"\n" +
	"countersvc\x18\x04 \x01(\tR\n" +
	"countersvc\x12\x1e\n" +
	"\n" +
	"contentsvc\x18\x05 \x01(\tR\n" +
	"contentsvc\"\xc8\x02\n" +
	...
	"\x0eServiceVersion\x18\x02 \x01(\tR\x0eServiceVersion\x12\x1a\n" +
	"\bEndpoint\x18\x03 \x01(\tR\bEndpointB\x1eZ\x1cclasslist/internal/conf;confb\x06proto3"
...
var file_conf_proto_goTypes = []any{
	...
	(*OtelConfig)(nil),    // 7: kratos.api.OtelConfig
...
var file_conf_proto_depIdxs = []int32{
	...
	7,  // 5: kratos.api.Bootstrap.otel:type_name -> kratos.api.OtelConfig
