...
type GetSemesterRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Date          string                 `protobuf:"bytes,1,opt,name=estimation,proto3" json:"estimation,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *GetSemesterListRequest) GetStudentId() string {
	if x != nil {
		return x.StudentId
	}
	return ""
...
const file_content_v1_content_proto_rawDesc = "" +
	...
	"\x13GetSemesterResponse\x120\n" +
	"\bsemester\x18\x01 \x01(\v2\x14.content.v1.semesterR\bsemester\"G\n" +
	"\x13SaveSemesterRequest\x120\n" +
	"\bsemester\x18\x01 \x01(\v2\x14.content.v1.semesterR\bsemester\"\x16\n" +
	"\x14SaveSemesterResponse\"7\n" +
	"\x16GetSemesterListRequest\x12\x1d\n" +
	"\n" +
...
var file_content_v1_content_proto_depIdxs = []int32{
	...
	39, // 9: content.v1.GetSemesterResponse.semester:type_name -> content.v1.semester
	39, // 10: content.v1.SaveSemesterRequest.semester:type_name -> content.v1.semester
	39, // 11: content.v1.GetSemesterListResponse.semesters:type_name -> content.v1.semester
	1,  // 12: content.v1.ContentService.GetCalendars:input_type -> content.v1.GetCalendarsRequest
	3,  // 13: content.v1.ContentService.SaveCalendar:input_type -> content.v1.SaveCalendarRequest
	5,  // 14: content.v1.ContentService.DelCalendar:input_type -> content.v1.DelCalendarRequest
	8,  // 15: content.v1.ContentService.GetBanners:input_type -> content.v1.GetBannersRequest
	10, // 16: content.v1.ContentService.SaveBanner:input_type -> content.v1.SaveBannerRequest
	12, // 17: content.v1.ContentService.DelBanner:input_type -> content.v1.DelBannerRequest
	15, // 18: content.v1.ContentService.GetInfoSums:input_type -> content.v1.GetInfoSumsRequest
	17, // 19: content.v1.ContentService.SaveInfoSum:input_type -> content.v1.SaveInfoSumRequest
	19, // 20: content.v1.ContentService.DelInfoSum:input_type -> content.v1.DelInfoSumRequest
	22, // 21: content.v1.ContentService.GetDepartments:input_type -> content.v1.GetDepartmentsRequest
	24, // 22: content.v1.ContentService.SaveDepartment:input_type -> content.v1.SaveDepartmentRequest
	26, // 23: content.v1.ContentService.DelDepartment:input_type -> content.v1.DelDepartmentRequest
	29, // 24: content.v1.ContentService.GetWebsites:input_type -> content.v1.GetWebsitesRequest
	31, // 25: content.v1.ContentService.SaveWebsite:input_type -> content.v1.SaveWebsiteRequest
	33, // 26: content.v1.ContentService.DelWebsite:input_type -> content.v1.DelWebsiteRequest
	35, // 27: content.v1.ContentService.GetUpdateVersion:input_type -> content.v1.GetUpdateVersionRequest
	37, // 28: content.v1.ContentService.SaveUpdateVersion:input_type -> content.v1.SaveUpdateVersionRequest
	40, // 29: content.v1.ContentService.GetSemester:input_type -> content.v1.GetSemesterRequest
	42, // 30: content.v1.ContentService.SaveSemester:input_type -> content.v1.SaveSemesterRequest
	44, // 31: content.v1.ContentService.GetSemesterList:input_type -> content.v1.GetSemesterListRequest
	2,  // 32: content.v1.ContentService.GetCalendars:output_type -> content.v1.GetCalendarsResponse
	4,  // 33: content.v1.ContentService.SaveCalendar:output_type -> content.v1.SaveCalendarResponse
	6,  // 34: content.v1.ContentService.DelCalendar:output_type -> content.v1.DelCalendarResponse
	9,  // 35: content.v1.ContentService.GetBanners:output_type -> content.v1.GetBannersResponse
	11, // 36: content.v1.ContentService.SaveBanner:output_type -> content.v1.SaveBannerResponse
	13, // 37: content.v1.ContentService.DelBanner:output_type -> content.v1.DelBannerResponse
	16, // 38: content.v1.ContentService.GetInfoSums:output_type -> content.v1.GetInfoSumsResponse
	18, // 39: content.v1.ContentService.SaveInfoSum:output_type -> content.v1.SaveInfoSumResponse
	20, // 40: content.v1.ContentService.DelInfoSum:output_type -> content.v1.DelInfoSumResponse
	23, // 41: content.v1.ContentService.GetDepartments:output_type -> content.v1.GetDepartmentsResponse
	25, // 42: content.v1.ContentService.SaveDepartment:output_type -> content.v1.SaveDepartmentResponse
	27, // 43: content.v1.ContentService.DelDepartment:output_type -> content.v1.DelDepartmentResponse
	30, // 44: content.v1.ContentService.GetWebsites:output_type -> content.v1.GetWebsitesResponse
	32, // 45: content.v1.ContentService.SaveWebsite:output_type -> content.v1.SaveWebsiteResponse
	34, // 46: content.v1.ContentService.DelWebsite:output_type -> content.v1.DelWebsiteResponse
	36, // 47: content.v1.ContentService.GetUpdateVersion:output_type -> content.v1.GetUpdateVersionResponse
	38, // 48: content.v1.ContentService.SaveUpdateVersion:output_type -> content.v1.SaveUpdateVersionResponse
	41, // 49: content.v1.ContentService.GetSemester:output_type -> content.v1.GetSemesterResponse
	43, // 50: content.v1.ContentService.SaveSemester:output_type -> content.v1.SaveSemesterResponse
	45, // 51: content.v1.ContentService.GetSemesterList:output_type -> content.v1.GetSemesterListResponse
