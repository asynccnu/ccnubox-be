...
import (
	v1 "github.com/asynccnu/ccnubox-be/common/api/gen/proto/classlist/v1" // 此处改成了api的部分
...
var (
	...
	ErrClassScheduleConflict = errors.New(464, v1.ErrorReason_ErrClassScheduleConflict.String(), "添加课程时间冲突")
)
