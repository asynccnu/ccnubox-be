...
type Seat struct {
	...
	AfterFree     bool                   `protobuf:"varint,5,opt,name=AfterFree,proto3" json:"AfterFree,omitempty"`
	FreeList      []*FreeTime            `protobuf:"bytes,6,rep,name=FreeList,proto3" json:"FreeList,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Seat) GetFreeList() []*FreeTime {
	if x != nil {
		return x.FreeList
	}
	return nil
...
func (x *FreeTime) GetStart() string {
	if x != nil {
		return x.Start
	}
	return ""
...
type GetSeatRecordRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	StuId         string                 `protobuf:"bytes,1,opt,name=stu_id,json=stuId,proto3" json:"stu_id,omitempty"`
	Date          []string               `protobuf:"bytes,2,rep,name=date,proto3" json:"date,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *GetSeatRecordRequest) GetDate() []string {
	if x != nil {
		return x.Date
	}
	return nil
...
type Record struct {
	...
	BuildName     string                 `protobuf:"bytes,4,opt,name=build_name,json=buildName,proto3" json:"build_name,omitempty"`
	FloorName     string                 `protobuf:"bytes,5,opt,name=floor_name,json=floorName,proto3" json:"floor_name,omitempty"`
	SeatId        string                 `protobuf:"bytes,6,opt,name=seat_id,json=seatId,proto3" json:"seat_id,omitempty"`
	SeatLabel     string                 `protobuf:"bytes,7,opt,name=seat_label,json=seatLabel,proto3" json:"seat_label,omitempty"`
	MakeBegin     string                 `protobuf:"bytes,8,opt,name=make_begin,json=makeBegin,proto3" json:"make_begin,omitempty"`
	MakeEnd       string                 `protobuf:"bytes,9,opt,name=make_end,json=makeEnd,proto3" json:"make_end,omitempty"`
	MakeDate      string                 `protobuf:"bytes,10,opt,name=make_date,json=makeDate,proto3" json:"make_date,omitempty"`
...
func (x *Record) GetBuildName() string {
	if x != nil {
		return x.BuildName
	}
	return ""
...
func (x *Record) GetFloorName() string {
	if x != nil {
		return x.FloorName
	}
	return ""
...
func (x *Record) GetSeatId() string {
	if x != nil {
		return x.SeatId
	}
	return ""
...
func (x *Record) GetSeatLabel() string {
	if x != nil {
		return x.SeatLabel
	}
	return ""
...
func (x *Record) GetMakeBegin() string {
	if x != nil {
		return x.MakeBegin
	}
	return ""
...
func (x *Record) GetMakeEnd() string {
	if x != nil {
		return x.MakeEnd
	}
	return ""
...
func (x *Record) GetMakeDate() string {
	if x != nil {
		return x.MakeDate
	}
	return ""
...
func (x *GetDiscussionRequest) GetRoomType() string {
	if x != nil {
		return x.RoomType
	}
	return ""
...
func (x *GetDiscussionRequest) GetVenueId() string {
	if x != nil {
		return x.VenueId
	}
	return ""
...
type Discussion struct {
	...
	DisableList   []*DisableTime         `protobuf:"bytes,6,rep,name=DisableList,proto3" json:"DisableList,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Discussion) GetRoomId() string {
	if x != nil {
		return x.RoomId
	}
	return ""
...
func (x *Discussion) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *Discussion) GetVenueId() string {
	if x != nil {
		return x.VenueId
	}
	return ""
...
func (x *Discussion) GetRoomType() string {
	if x != nil {
		return x.RoomType
	}
	return ""
...
func (x *Discussion) GetAddress() string {
	if x != nil {
		return x.Address
	}
	return ""
...
func (x *Discussion) GetDisableList() []*DisableTime {
	if x != nil {
...
func (x *DisableTime) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DisableTime) ProtoMessage() {}

func (x *DisableTime) ProtoReflect() protoreflect.Message {
	mi := &file_library_v1_library_proto_msgTypes[18]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DisableTime.ProtoReflect.Descriptor instead.
func (*DisableTime) Descriptor() ([]byte, []int) {
	return file_library_v1_library_proto_rawDescGZIP(), []int{18}
}

func (x *DisableTime) GetStart() string {
	if x != nil {
		return x.Start
	}
	return ""
...
func (x *DisableTime) GetEnd() string {
	if x != nil {
		return x.End
	}
	return ""
...
type ReserveSeatRandomlyRequest struct {
	...
	End           string                 `protobuf:"bytes,2,opt,name=end,proto3" json:"end,omitempty"`
	StuId         string                 `protobuf:"bytes,3,opt,name=stu_id,json=stuId,proto3" json:"stu_id,omitempty"`
	RoomId        []string               `protobuf:"bytes,4,rep,name=room_id,json=roomId,proto3" json:"room_id,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type GetRandomSeatRequest struct {
	...
	StuId          string                 `protobuf:"bytes,1,opt,name=stu_id,json=stuId,proto3" json:"stu_id,omitempty"`
	RoomIds        []string               `protobuf:"bytes,2,rep,name=room_ids,json=roomIds,proto3" json:"room_ids,omitempty"`
	Date           string                 `protobuf:"bytes,3,opt,name=date,proto3" json:"date,omitempty"`                                             // 预约日期，格式 YYYY-MM-DD
	Start          string                 `protobuf:"bytes,4,opt,name=start,proto3" json:"start,omitempty"`                                           // 开始时间，格式 HH:MM
	End            string                 `protobuf:"bytes,5,opt,name=end,proto3" json:"end,omitempty"`                                               // 结束时间，格式 HH:MM
	ExcludeSeatIds []string               `protobuf:"bytes,6,rep,name=exclude_seat_ids,json=excludeSeatIds,proto3" json:"exclude_seat_ids,omitempty"` // 需要排除的座位（重新随机时传入，避免重复）
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}

func (x *GetRandomSeatRequest) Reset() {
	*x = GetRandomSeatRequest{}
	mi := &file_library_v1_library_proto_msgTypes[27]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetRandomSeatRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetRandomSeatRequest) ProtoMessage() {}

func (x *GetRandomSeatRequest) ProtoReflect() protoreflect.Message {
	mi := &file_library_v1_library_proto_msgTypes[27]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetRandomSeatRequest.ProtoReflect.Descriptor instead.
func (*GetRandomSeatRequest) Descriptor() ([]byte, []int) {
	return file_library_v1_library_proto_rawDescGZIP(), []int{27}
}

func (x *GetRandomSeatRequest) GetStuId() string {
	if x != nil {
		return x.StuId
	}
	return ""
...
func (x *GetRandomSeatRequest) GetRoomIds() []string {
	if x != nil {
		return x.RoomIds
	}
	return nil
...
func (x *GetRandomSeatRequest) GetDate() string {
	if x != nil {
		return x.Date
	}
	return ""
...
func (x *GetRandomSeatRequest) GetStart() string {
	if x != nil {
		return x.Start
	}
	return ""
...
func (x *GetRandomSeatRequest) GetEnd() string {
	if x != nil {
		return x.End
	}
	return ""
...
func (x *GetRandomSeatRequest) GetExcludeSeatIds() []string {
	if x != nil {
		return x.ExcludeSeatIds
	}
	return nil
}
...
func (x *GetRandomSeatResponse) Reset() {
	*x = GetRandomSeatResponse{}
	mi := &file_library_v1_library_proto_msgTypes[28]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetRandomSeatResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetRandomSeatResponse) ProtoMessage() {}

func (x *GetRandomSeatResponse) ProtoReflect() protoreflect.Message {
	mi := &file_library_v1_library_proto_msgTypes[28]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetRandomSeatResponse.ProtoReflect.Descriptor instead.
func (*GetRandomSeatResponse) Descriptor() ([]byte, []int) {
	return file_library_v1_library_proto_rawDescGZIP(), []int{28}
}

func (x *GetRandomSeatResponse) GetRoomId() string {
	if x != nil {
		return x.RoomId
	}
	return ""
...
func (x *GetRandomSeatResponse) GetSeat() *Seat {
	if x != nil {
		return x.Seat
	}
	return nil
...
func (x *ConfirmReservationRequest) GetStuId() string {
	if x != nil {
		return x.StuId
	}
	return ""
...
func (x *ConfirmReservationRequest) GetDevId() string {
	if x != nil {
		return x.DevId
	}
	return ""
...
func (x *ConfirmReservationRequest) GetDate() string {
	if x != nil {
		return x.Date
	}
	return ""
...
func (x *ConfirmReservationRequest) GetStart() string {
	if x != nil {
		return x.Start
	}
	return ""
...
func (x *ConfirmReservationRequest) GetEnd() string {
	if x != nil {
		return x.End
	}
	return ""
...
const file_library_v1_library_proto_rawDesc = "" +
	...
	"\x05seats\x18\x02 \x03(\v2\x10.library.v1.SeatR\x05seats\"\xa8\x01\n" +
	"\x04Seat\x12\x0e\n" +
	"\x02ID\x18\x01 \x01(\tR\x02ID\x12\x14\n" +
	"\x05Label\x18\x02 \x01(\tR\x05Label\x12\x12\n" +
	"\x04Name\x18\x03 \x01(\tR\x04Name\x12\x16\n" +
	"\x06Status\x18\x04 \x01(\tR\x06Status\x12\x1c\n" +
	"\tAfterFree\x18\x05 \x01(\bR\tAfterFree\x120\n" +
	"\bFreeList\x18\x06 \x03(\v2\x14.library.v1.FreeTimeR\bFreeList\"2\n" +
	"\bFreeTime\x12\x14\n" +
	"\x05start\x18\x01 \x01(\tR\x05start\x12\x10\n" +
	"\x03end\x18\x02 \x01(\tR\x03end\"v\n" +
	"\bTimeSlot\x12\x14\n" +
	"\x05start\x18\x01 \x01(\tR\x05start\x12\x10\n" +
	...
	"\x04date\x18\x02 \x03(\tR\x04date\"C\n" +
	"\x15GetSeatRecordResponse\x12*\n" +
	"\x06record\x18\x01 \x03(\v2\x12.library.v1.RecordR\x06record\"\xcd\x02\n" +
	"\x06Record\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x17\n" +
	"\aroom_id\x18\x02 \x01(\tR\x06roomId\x12\x1b\n" +
	"\troom_name\x18\x03 \x01(\tR\broomName\x12\x1d\n" +
	"\n" +
	"build_name\x18\x04 \x01(\tR\tbuildName\x12\x1d\n" +
	"\n" +
	"floor_name\x18\x05 \x01(\tR\tfloorName\x12\x17\n" +
	"\aseat_id\x18\x06 \x01(\tR\x06seatId\x12\x1d\n" +
	"\n" +
	"seat_label\x18\a \x01(\tR\tseatLabel\x12\x1d\n" +
	"\n" +
	"make_begin\x18\b \x01(\tR\tmakeBegin\x12\x19\n" +
	"\bmake_end\x18\t \x01(\tR\amakeEnd\x12\x1b\n" +
	"\tmake_date\x18\n" +
	" \x01(\tR\bmakeDate\x12\x16\n" +
	...
	"\x14GetDiscussionRequest\x12\x1b\n" +
	"\troom_type\x18\x01 \x01(\tR\broomType\x12\x12\n" +
	"\x04date\x18\x02 \x01(\tR\x04date\x12\x15\n" +
	"\x06stu_id\x18\x03 \x01(\tR\x05stuId\x12\x19\n" +
	"\bvenue_id\x18\x04 \x01(\tR\avenueId\"Q\n" +
	"\x15GetDiscussionResponse\x128\n" +
	"\vdiscussions\x18\x01 \x03(\v2\x16.library.v1.DiscussionR\vdiscussions\"\xc5\x01\n" +
	"\n" +
	"Discussion\x12\x17\n" +
	"\aroom_id\x18\x01 \x01(\tR\x06roomId\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12\x19\n" +
	"\bvenue_id\x18\x03 \x01(\tR\avenueId\x12\x1a\n" +
	"\broomType\x18\x04 \x01(\tR\broomType\x12\x18\n" +
	"\aaddress\x18\x05 \x01(\tR\aaddress\x129\n" +
	"\vDisableList\x18\x06 \x03(\v2\x17.library.v1.DisableTimeR\vDisableList\"5\n" +
	"\vDisableTime\x12\x14\n" +
	"\x05start\x18\x01 \x01(\tR\x05start\x12\x10\n" +
	"\x03end\x18\x02 \x01(\tR\x03end\"I\n" +
	...
	"\x10exclude_seat_ids\x18\x06 \x03(\tR\x0eexcludeSeatIds\"V\n" +
	"\x15GetRandomSeatResponse\x12\x17\n" +
	"\aroom_id\x18\x01 \x01(\tR\x06roomId\x12$\n" +
	"\x04seat\x18\x02 \x01(\v2\x10.library.v1.SeatR\x04seat\"\x85\x01\n" +
	"\x19ConfirmReservationRequest\x12\x15\n" +
	"\x06stu_id\x18\x01 \x01(\tR\x05stuId\x12\x15\n" +
	...
	"\x04Resp\x12\x18\n" +
	"\amessage\x18\x01 \x01(\tR\amessage2\x80\t\n" +
...
var file_library_v1_library_proto_goTypes = []any{
	...
	(*FreeTime)(nil),                    // 4: library.v1.FreeTime
	(*TimeSlot)(nil),                    // 5: library.v1.TimeSlot
	(*ReserveSeatRequest)(nil),          // 6: library.v1.ReserveSeatRequest
	(*ReserveSeatResponse)(nil),         // 7: library.v1.ReserveSeatResponse
	(*GetSeatRecordRequest)(nil),        // 8: library.v1.GetSeatRecordRequest
	(*GetSeatRecordResponse)(nil),       // 9: library.v1.GetSeatRecordResponse
	(*Record)(nil),                      // 10: library.v1.Record
	(*GetCreditPointRequest)(nil),       // 11: library.v1.GetCreditPointRequest
	(*GetCreditPointResponse)(nil),      // 12: library.v1.GetCreditPointResponse
	(*CreditSummary)(nil),               // 13: library.v1.CreditSummary
	(*CreditRecord)(nil),                // 14: library.v1.CreditRecord
	(*GetDiscussionRequest)(nil),        // 15: library.v1.GetDiscussionRequest
	(*GetDiscussionResponse)(nil),       // 16: library.v1.GetDiscussionResponse
	(*Discussion)(nil),                  // 17: library.v1.Discussion
	(*DisableTime)(nil),                 // 18: library.v1.DisableTime
	(*SearchUserRequest)(nil),           // 19: library.v1.SearchUserRequest
	(*SearchUserResponse)(nil),          // 20: library.v1.SearchUserResponse
	(*ReserveDiscussionRequest)(nil),    // 21: library.v1.ReserveDiscussionRequest
	(*ReserveDiscussionResponse)(nil),   // 22: library.v1.ReserveDiscussionResponse
	(*CancelReserveRequest)(nil),        // 23: library.v1.CancelReserveRequest
	(*CancelReserveResponse)(nil),       // 24: library.v1.CancelReserveResponse
	(*ReserveSeatRandomlyRequest)(nil),  // 25: library.v1.ReserveSeatRandomlyRequest
	(*ReserveSeatRandomlyResponse)(nil), // 26: library.v1.ReserveSeatRandomlyResponse
	(*GetRandomSeatRequest)(nil),        // 27: library.v1.GetRandomSeatRequest
...
var file_library_v1_library_proto_depIdxs = []int32{
	...
	4,  // 2: library.v1.Seat.FreeList:type_name -> library.v1.FreeTime
	10, // 3: library.v1.GetSeatRecordResponse.record:type_name -> library.v1.Record
	13, // 4: library.v1.GetCreditPointResponse.credit_summary:type_name -> library.v1.CreditSummary
	14, // 5: library.v1.GetCreditPointResponse.credit_record:type_name -> library.v1.CreditRecord
	...
	0,  // 10: library.v1.LibraryService.GetSeat:input_type -> library.v1.GetSeatRequest
	6,  // 11: library.v1.LibraryService.ReserveSeat:input_type -> library.v1.ReserveSeatRequest
	8,  // 12: library.v1.LibraryService.GetSeatRecord:input_type -> library.v1.GetSeatRecordRequest
	11, // 13: library.v1.LibraryService.GetCreditPoint:input_type -> library.v1.GetCreditPointRequest
	15, // 14: library.v1.LibraryService.GetDiscussion:input_type -> library.v1.GetDiscussionRequest
	19, // 15: library.v1.LibraryService.SearchUser:input_type -> library.v1.SearchUserRequest
	21, // 16: library.v1.LibraryService.ReserveDiscussion:input_type -> library.v1.ReserveDiscussionRequest
	23, // 17: library.v1.LibraryService.CancelReserve:input_type -> library.v1.CancelReserveRequest
	25, // 18: library.v1.LibraryService.ReserveSeatRandomly:input_type -> library.v1.ReserveSeatRandomlyRequest
	27, // 19: library.v1.LibraryService.GetRandomSeat:input_type -> library.v1.GetRandomSeatRequest
	29, // 20: library.v1.LibraryService.ConfirmReservation:input_type -> library.v1.ConfirmReservationRequest
	32, // 21: library.v1.LibraryService.CreateComment:input_type -> library.v1.CreateCommentReq
	34, // 22: library.v1.LibraryService.GetComments:input_type -> library.v1.ID
	34, // 23: library.v1.LibraryService.DeleteComment:input_type -> library.v1.ID
	1,  // 24: library.v1.LibraryService.GetSeat:output_type -> library.v1.GetSeatResponse
	7,  // 25: library.v1.LibraryService.ReserveSeat:output_type -> library.v1.ReserveSeatResponse
	9,  // 26: library.v1.LibraryService.GetSeatRecord:output_type -> library.v1.GetSeatRecordResponse
	12, // 27: library.v1.LibraryService.GetCreditPoint:output_type -> library.v1.GetCreditPointResponse
	16, // 28: library.v1.LibraryService.GetDiscussion:output_type -> library.v1.GetDiscussionResponse
	20, // 29: library.v1.LibraryService.SearchUser:output_type -> library.v1.SearchUserResponse
	22, // 30: library.v1.LibraryService.ReserveDiscussion:output_type -> library.v1.ReserveDiscussionResponse
	24, // 31: library.v1.LibraryService.CancelReserve:output_type -> library.v1.CancelReserveResponse
	26, // 32: library.v1.LibraryService.ReserveSeatRandomly:output_type -> library.v1.ReserveSeatRandomlyResponse
	28, // 33: library.v1.LibraryService.GetRandomSeat:output_type -> library.v1.GetRandomSeatResponse
	30, // 34: library.v1.LibraryService.ConfirmReservation:output_type -> library.v1.ConfirmReservationResponse
	35, // 35: library.v1.LibraryService.CreateComment:output_type -> library.v1.Resp
	33, // 36: library.v1.LibraryService.GetComments:output_type -> library.v1.GetCommentResp
	35, // 37: library.v1.LibraryService.DeleteComment:output_type -> library.v1.Resp
