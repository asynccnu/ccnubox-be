...
var file_classService_v1_free_classroom_proto_rawDesc = []byte{
	...
	0x61, 0x73, 0x73, 0x72, 0x6f, 0x6f, 0x6d, 0x52, 0x65, 0x73, 0x70, 0x42, 0x54, 0x5a, 0x52, 0x67,
	...
	0x74, 0x6f, 0x2f, 0x63, 0x6c, 0x61, 0x73, 0x73, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2f,
	0x76, 0x31, 0x3b, 0x63, 0x6c, 0x61, 0x73, 0x73, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x76,
...
var file_classService_v1_free_classroom_proto_goTypes = []interface{}{
...
func file_classService_v1_free_classroom_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_classService_v1_free_classroom_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*QueryFreeClassroomReq); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_classService_v1_free_classroom_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*QueryFreeClassroomResp); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_classService_v1_free_classroom_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ClassroomAvailableStat); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
