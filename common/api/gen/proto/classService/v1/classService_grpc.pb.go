...
const (
	...
	ClassService_GetClassToBeStudied_FullMethodName = "/classService.v1.ClassService/GetClassToBeStudied"
)
...
func (c *classServiceClient) GetClassToBeStudied(ctx context.Context, in *GetClassToBeStudiedRequest, opts ...grpc.CallOption) (*GetClassToBeStudiedReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetClassToBeStudiedReply)
	err := c.cc.Invoke(ctx, ClassService_GetClassToBeStudied_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedClassServiceServer) SearchClass(context.Context, *SearchRequest) (*SearchReply, error) {
	return nil, status.Error(codes.Unimplemented, "method SearchClass not implemented")
}
...
func (UnimplementedClassServiceServer) GetClassToBeStudied(context.Context, *GetClassToBeStudiedRequest) (*GetClassToBeStudiedReply, error) {
	return nil, status.Error(codes.Unimplemented, "method GetClassToBeStudied not implemented")
}
...
func _ClassService_GetClassToBeStudied_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetClassToBeStudiedRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ClassServiceServer).GetClassToBeStudied(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ClassService_GetClassToBeStudied_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClassServiceServer).GetClassToBeStudied(ctx, req.(*GetClassToBeStudiedRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ClassService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetClassToBeStudied",
			Handler:    _ClassService_GetClassToBeStudied_Handler,
		},
	},
