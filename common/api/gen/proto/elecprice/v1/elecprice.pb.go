...
const file_elecprice_v1_elecprice_proto_rawDesc = "" +
	...
	"\troom_name\x18\x01 \x01(\tR\broomName\"\xc8\x02\n" +
	"\x10GetPriceResponse\x124\n" +
	"\x02ac\x18\x01 \x01(\v2$.elecprice.v1.GetPriceResponse.PriceR\x02ac\x12:\n" +
	"\x05light\x18\x02 \x01(\v2$.elecprice.v1.GetPriceResponse.PriceR\x05light\x12:\n" +
	"\x05union\x18\x03 \x01(\v2$.elecprice.v1.GetPriceResponse.PriceR\x05union\x1a\x85\x01\n" +
	"\x05Price\x12 \n" +
