...
const file_user_v1_user_proto_rawDesc = "" +
	...
	"\x10GetLibraryCookie\x12 .user.v1.GetLibraryCookieRequest\x1a!.user.v1.GetLibraryCookieResponseBGZEgithub.com/asynccnu/ccnubox-be/common/be-api/gen/proto/user/v1;userv1b\x06proto3"
