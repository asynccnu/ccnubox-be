...
func InitApp() *App {
	...
	proxyGetter := service.NewProxyService(proxyClient, logger)
	elecpriceService := service.NewElecpriceService(elecpriceDAO, logger, elecPriceCache, proxyGetter)
	...
	v := cron.NewCron(elecpriceController, proxyGetter)
