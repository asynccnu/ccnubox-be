...
const file_infoSum_v1_infoSum_error_proto_rawDesc = "" +
	"\n" +
	"\x1einfoSum/v1/infoSum_error.proto\x12\n" +
	"infoSum.v1\x1a\x13errors/errors.proto*k\n" +
	"\vErrorReason\x12\x1b\n" +
	"\x11GET_INFOSUM_ERROR\x10\x00\x1a\x04\xa8E\xf5\x03\x12\x1b\n" +
	"\x11DEL_INFOSUM_ERROR\x10\x01\x1a\x04\xa8E\xf6\x03\x12\x1c\n" +
	"\x12SAVE_INFOSUM_ERROR\x10\x02\x1a\x04\xa8E\xf7\x03\x1a\x04\xa0E\xf4\x03BMZKgithub.com/asynccnu/ccnubox-be/common/be-api/gen/proto/infoSum/v1;infoSumv1b\x06proto3"

var (
	file_infoSum_v1_infoSum_error_proto_rawDescOnce sync.Once
	file_infoSum_v1_infoSum_error_proto_rawDescData []byte
)

func file_infoSum_v1_infoSum_error_proto_rawDescGZIP() []byte {
	file_infoSum_v1_infoSum_error_proto_rawDescOnce.Do(func() {
		file_infoSum_v1_infoSum_error_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_infoSum_v1_infoSum_error_proto_rawDesc), len(file_infoSum_v1_infoSum_error_proto_rawDesc)))
	})
...
var file_infoSum_v1_infoSum_error_proto_goTypes = []any{
...
func file_infoSum_v1_infoSum_error_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_infoSum_v1_infoSum_error_proto_rawDesc), len(file_infoSum_v1_infoSum_error_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
