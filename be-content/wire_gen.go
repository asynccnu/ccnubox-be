...
func InitApp() *App {
	...
	versionService := service.NewVersionService(serverConf, logger)
	contentServiceServer := grpc.NewCalendarServiceServer(calendarService, bannerService, departmentService, websiteService, infoSumService, versionService)
	...
	updateVersionController := cron.NewUpdateVersionController(versionService, logger)
	v := cron.NewCron(calendarController, updateVersionController)
