...
func (c *Crawler) GetClassInfoForGraduateStudent(ctx context.Context, stuID, year, semester, cookie string) ([]*model.ClassInfoBO, []*model.StudentCourseBO, int, error) {
	// 获取代理并将其存入请求的上下文
...
func (c *Crawler) GetClassInfosForUndergraduate(ctx context.Context, stuID, year, semester, cookie string) ([]*model.ClassInfoBO, []*model.StudentCourseBO, int, error) {
	// 获取代理并将其存入请求的上下文
	proxyURL := c.pg.GetProxy(ctx)
...
func extractUndergraduateData(rawJson []byte, stuID, xnm, xqm string) ([]*model.ClassInfoBO, []*model.StudentCourseBO, int, error) {
