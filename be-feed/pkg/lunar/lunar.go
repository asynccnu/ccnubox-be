...
// 这个文件是抄的https://github.com/FrankWong1213/golang-lunar/blob/master/lunar.go,为什么不import呢?主要是怕私人库归档了
...
var (
	...
	timeFormat_yyyyMMdd   string = "2006-01-02"
...
// 输入日期格式为yyyyMMdd,如2015-01-01
func gregorianToLunar(date string) string {
	...
	//这里把年删除掉了,因为没什么用
	return doubleMonth + chineseNumber[month-1] + "月" + getChinaDayString(day)
}
