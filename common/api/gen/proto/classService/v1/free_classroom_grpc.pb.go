...
const (
	...
	FreeClassroomSvc_GetClassrooms_FullMethodName      = "/classService.v1.FreeClassroomSvc/GetClassrooms"
)
...
type FreeClassroomSvcClient interface {
	...
	GetClassrooms(ctx context.Context, in *GetClassroomsReq, opts ...grpc.CallOption) (*GetClassroomsResp, error)
}
...
func (c *freeClassroomSvcClient) GetClassrooms(ctx context.Context, in *GetClassroomsReq, opts ...grpc.CallOption) (*GetClassroomsResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetClassroomsResp)
	err := c.cc.Invoke(ctx, FreeClassroomSvc_GetClassrooms_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type FreeClassroomSvcServer interface {
	...
	GetClassrooms(context.Context, *GetClassroomsReq) (*GetClassroomsResp, error)
...
func (UnimplementedFreeClassroomSvcServer) GetClassrooms(context.Context, *GetClassroomsReq) (*GetClassroomsResp, error) {
...
func _FreeClassroomSvc_GetClassrooms_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetClassroomsReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(FreeClassroomSvcServer).GetClassrooms(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: FreeClassroomSvc_GetClassrooms_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FreeClassroomSvcServer).GetClassrooms(ctx, req.(*GetClassroomsReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var FreeClassroomSvc_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _FreeClassroomSvc_GetClassrooms_Handler,
		},
	},
