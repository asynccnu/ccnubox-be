...
const (
	...
	GradeService_GetUpdateScore_FullMethodName = "/grade.v1.GradeService/GetUpdateScore"
...
type GradeServiceClient interface {
	...
	GetUpdateScore(ctx context.Context, in *GetUpdateScoreReq, opts ...grpc.CallOption) (*GetUpdateScoreResp, error)
	// 学业平均学分绩和排名
...
func (c *gradeServiceClient) GetUpdateScore(ctx context.Context, in *GetUpdateScoreReq, opts ...grpc.CallOption) (*GetUpdateScoreResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetUpdateScoreResp)
	err := c.cc.Invoke(ctx, GradeService_GetUpdateScore_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type GradeServiceServer interface {
	...
	GetUpdateScore(context.Context, *GetUpdateScoreReq) (*GetUpdateScoreResp, error)
	// 学业平均学分绩和排名
...
func (UnimplementedGradeServiceServer) GetGradeByTerm(context.Context, *GetGradeByTermReq) (*GetGradeByTermResp, error) {
	return nil, status.Error(codes.Unimplemented, "method GetGradeByTerm not implemented")
}
func (UnimplementedGradeServiceServer) GetGradeScore(context.Context, *GetGradeScoreReq) (*GetGradeScoreResp, error) {
	return nil, status.Error(codes.Unimplemented, "method GetGradeScore not implemented")
}
func (UnimplementedGradeServiceServer) GetGradeType(context.Context, *GetGradeTypeReq) (*GetGradeTypeResp, error) {
	return nil, status.Error(codes.Unimplemented, "method GetGradeType not implemented")
}
func (UnimplementedGradeServiceServer) GetUpdateScore(context.Context, *GetUpdateScoreReq) (*GetUpdateScoreResp, error) {
	return nil, status.Error(codes.Unimplemented, "method GetUpdateScore not implemented")
}
func (UnimplementedGradeServiceServer) GetRankByTerm(context.Context, *GetRankByTermReq) (*GetRankByTermResp, error) {
	return nil, status.Error(codes.Unimplemented, "method GetRankByTerm not implemented")
}
func (UnimplementedGradeServiceServer) LoadRank(context.Context, *LoadRankReq) (*EmptyResp, error) {
	return nil, status.Error(codes.Unimplemented, "method LoadRank not implemented")
}
...
func _GradeService_GetUpdateScore_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetUpdateScoreReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GradeServiceServer).GetUpdateScore(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: GradeService_GetUpdateScore_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GradeServiceServer).GetUpdateScore(ctx, req.(*GetUpdateScoreReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var GradeService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetUpdateScore",
			Handler:    _GradeService_GetUpdateScore_Handler,
		},
		{
	...
	Metadata: "common/api/proto/grade/v1/grade.proto",
}
