...
func InitGRPCxKratosServer(grpcServer *grpc.ContentServiceServer, ecli *clientv3.Client, l logger.Logger, cfg *conf.InfraConf) grpcx.Server {
	return server.InitGRPCxKratosServer(grpcServer, ecli, l, (*cfg.Grpc)[b_grpc.CONTENT], cfg.Env)
}
