        ...
        "/class/toBeStudied": {
            "get": {
                ...
                "responses": {
                    ...
                    "500": {
                        "description": "获取待修读课程失败，code=50608",
                        "schema": {
                            "$ref": "#/definitions/web.Response"
                        }
                    }
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/library.ConfirmReservationRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "成功返回预约结果",
                        "schema": {
                            "$ref": "#/definitions/web.Response"
                        }
                    },
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/library.GetRandomSeatRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "成功返回随机候选座位",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/web.Response"
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/library.GetRandomSeatResponse"
                                        }
                                    }
                                }
                            ]
                    ...
                    "500": {
                        "description": "系统异常，获取失败；该时段无可用座位时 code=51515",
                        "schema": {
                            "$ref": "#/definitions/web.Response"
                        }
                    }
    ...
    "definitions": {
        ...
        "feed.ChangeFeedAllowListReq": {
            ...
            "properties": {
                ...
                "library": {
                    "description": "Library 为可选字段，使已部署客户端的请求能够保留用户现有的图书馆提醒偏好。",
                    "type": "boolean"
                },
                "muxi": {
                    "type": "boolean"
        ...
        "library.ConfirmReservationRequest": {
            "type": "object",
            "properties": {
                "date": {
