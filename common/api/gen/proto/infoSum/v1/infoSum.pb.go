...
const file_infoSum_v1_infoSum_proto_rawDesc = "" +
	"\n" +
	"\x18infoSum/v1/infoSum.proto\x12\n" +
	"infoSum.v1\"y\n" +
	"\aInfoSum\x12\x0e\n" +
	...
	"\bInfoSums\x18\x01 \x03(\v2\x13.infoSum.v1.InfoSumR\bInfoSums\"C\n" +
	"\x12SaveInfoSumRequest\x12-\n" +
	"\aInfoSum\x18\x01 \x01(\v2\x13.infoSum.v1.InfoSumR\aInfoSum\"F\n" +
	"\x13SaveInfoSumResponse\x12/\n" +
	"\bInfoSums\x18\x01 \x03(\v2\x13.infoSum.v1.InfoSumR\bInfoSums\"#\n" +
	"\x11DelInfoSumRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x03R\x02id\"E\n" +
	"\x12DelInfoSumResponse\x12/\n" +
	"\bInfoSums\x18\x01 \x03(\v2\x13.infoSum.v1.InfoSumR\bInfoSums2\xfd\x01\n" +
	"\x0eInfoSumService\x12N\n" +
	...
	"\n" +
	"DelInfoSum\x12\x1d.infoSum.v1.DelInfoSumRequest\x1a\x1e.infoSum.v1.DelInfoSumResponseBJZHgithub.com/asynccnu/ccnubox-be/common/api/gen/proto/infoSum/v1;infoSumv1b\x06proto3"

var (
	file_infoSum_v1_infoSum_proto_rawDescOnce sync.Once
	file_infoSum_v1_infoSum_proto_rawDescData []byte
)

func file_infoSum_v1_infoSum_proto_rawDescGZIP() []byte {
	file_infoSum_v1_infoSum_proto_rawDescOnce.Do(func() {
		file_infoSum_v1_infoSum_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_infoSum_v1_infoSum_proto_rawDesc), len(file_infoSum_v1_infoSum_proto_rawDesc)))
	})
...
func file_infoSum_v1_infoSum_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_infoSum_v1_infoSum_proto_rawDesc), len(file_infoSum_v1_infoSum_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   1,
